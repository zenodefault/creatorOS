...
export default function SettingsPage() {
  ...
  return (
    <div className="bg-background-dark text-white min-h-screen flex flex-col overflow-hidden relative">
      ...
      {/* Top Navigation Bar */}
      <header className="flex items-center justify-between whitespace-nowrap border-b border-white/10 bg-[#0f172a]/80 backdrop-blur-md px-6 py-3 z-20 shrink-0">
        <div className="flex items-center gap-4 text-white">
          ...
          <h2 className="text-white text-lg font-bold leading-tight tracking-tight">Creator Mind</h2>
        </div>
        <div className="hidden md:flex flex-1 justify-end gap-8 items-center">
          ...
          <div 
            ...
            style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAVJKY0nMf9bQr9fAHlkfl-ddBGHY67sE2hsLj4BzpklwyaRKHa8Zr-caU_lLFzjsNPD2EcZQykmUot9ri1UEfuuk0jNgqOahbL-STNEZUgVKziGBqa93OOa6H_rsdhi6k_5kRZ1e3Yv_A2u57MMWKmNC1wRcD-yN-tFJENluqiLCKnL6eSlUloymBaMrn4vEfg-l1NHDSrLfHbymCk1lr2UB3bbmFySI30DzLighUN9dSHg1SiE4red7aaSQUAUk6X1x0xCsqgA0w")' }}
          ></div>
        </div>
      </header>
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar Navigation */}
        <aside className="w-64 hidden lg:flex flex-col border-r border-white/10 bg-[#0f172a]/50 backdrop-blur-sm p-4 gap-6 shrink-0 z-10">
        ...
        <main className="flex-1 overflow-y-auto relative w-full">
          <div className="max-w-[1000px] mx-auto px-4 py-8 md:px-12 md:py-10 flex flex-col gap-8">
            {/* Page Heading */}
            <div className="flex flex-col gap-2">
              <h1 className="text-white text-3xl font-bold tracking-tight">Profile Settings</h1>
              <p className="text-gray-400 text-base font-normal">Manage your public profile information and integrations.</p>
            </div>

            {/* Glass Card 1: Personal Details */}
            <div className="rounded-2xl border-white/10 bg-surface-glass backdrop-blur-xl shadow-xl overflow-hidden">
              <div className="p-6 md:p-8 flex flex-col gap-8">
                {/* Avatar Section */}
                <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start border-b border-white/5 pb-8">
                  ...
                  <div className="flex flex-col gap-2 text-center sm:text-left pt-2">
                    <h3 className="text-white text-xl font-bold">Profile Photo</h3>
                    <p className="text-gray-400 text-sm max-w-xs">Upload a new avatar. Recommended size 400x400px. JPG, PNG or GIF.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <label className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        className="w-full bg-[#0f172a]/60 border border-white/10 rounded-xl px-4 pl-11 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all text-sm" 
                  ...
                  <label className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        type="email" 
                        defaultValue="alex@creatormind.com"
                      />
                    </div>
                  </label>
                  ...
                  <label className="flex flex-col gap-2 md:col-span-2">
                    ...
                    <div className="relative">
                      <Monitor className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 text-[20px]" size={20} />
                      <select className="w-full bg-[#0f172a]/60 border-white/10 rounded-xl px-4 pl-11 py-3 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary appearance-none transition-all text-sm cursor-pointer">
                  ...
                  <label className="flex flex-col gap-2 md:col-span-2">
                    ...
                    <textarea 
                      className="w-full bg-[#0f172a]/60 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all resize-none text-sm" 
