      ...
      <div className="relative flex min-h-screen w-full flex-col justify-center items-center overflow-hidden bg-gradient-to-br from-background-light via-[#e0e7ff] to-[#f0fdf4] py-10 px-4 dark:from-[#101322] dark:to-[#1a1d30]">
        ...
        <div className="bg-white/75 backdrop-blur-lg border border-white/50 shadow-[0_8px_32px_0_rgba(68,97,238,0.15)] w-full max-w-[480px] rounded-2xl p-8 sm:p-12 relative z-10 transition-all duration-300 dark:bg-[#1a1d30]/80 dark:border-[#ffffff]/10">
          ...
          <div className="mb-8 text-center flex flex-col items-center">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-[#111218] mb-2">Create Your Account</h1>
            <p className="text-[#616889] text-sm font-normal">Join the Creator Mind community today.</p>
          </div>
              ...
              {isLoading ? (
                ...
                <>
                  ...
                  <svg className="h-5 w-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M12 23c2.97 0 5.46-.98 7.28-2.6l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"></path>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  className="block w-full rounded-xl border-gray-20 bg-white/80 py-3.5 pl-10 pr-3 text-[#111218] placeholder:text-[#616889] focus:border-primary focus:ring-primary sm:text-sm shadow-sm transition-all duration-200 hover:bg-white" 
                  id="email"
                  name="email"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  className="block w-full rounded-xl border-gray-200 bg-white/80 py-3.5 pl-10 pr-10 text-[#11218] placeholder:text-[#616889] focus:border-primary focus:ring-primary sm:text-sm shadow-sm transition-all duration-200 hover:bg-white"
                  id="password"
                  name="password"
            ...
            <div className="space-y-1.5">
              <label className="block text-sm font-medium text-[#111218]" htmlFor="confirmPassword">Confirm Password</label>
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                  <Lock className="text-gray-400 text-sm" />
                </div>
